...
const { getNextQueuedItem, getCaptionPaths, getSidecarPaths } = require("./queue");
...
async function postSingleVideo({ videoPath, caption, source, postedDir, failedDir, accountId, onPhase, scheduledAt, scheduleTimezone, location, aiGenerated }) {
  ...
  const result = await uploadVideo({ videoPath, caption, source, accountId, onPhase, scheduledAt, scheduleTimezone, location, aiGenerated });
