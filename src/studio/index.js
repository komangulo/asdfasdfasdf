...
function createStudioModule({ rootPath, databasePath, getActiveAccount, requireAccount, getAccountQueueDirs, flowConfig, fetchImpl, googleFlow = defaultGoogleFlow, mediaPollMs }) {
